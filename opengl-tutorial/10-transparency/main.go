...
// Tutorial 10 - Transperancy ported from
...
func main() {
	...
	window, err := glfw.CreateWindow(1024, 768, "Tutorial 10", nil, nil)
	if err != nil {
		panic(err)
	}
	...
	programId := common.LoadShaders("StandardShading.vertexshader", "StandardTransperantShading.fragmentshader")
